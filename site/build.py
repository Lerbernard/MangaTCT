...
.herocredit{{margin:10px 2px 0;font-size:13px;color:var(--dim)}}
...
<section class="hero"><div class="wrap">
  ...
  <!-- lee: *"update the website hero screenshot with the new ones"*. The page
       in it is Pepper&Carrot, whose licence (CC BY 4.0) asks for the credit
       wherever the picture is shown, so the credit sits right under it. -->
  <p class="herocredit">The comic on screen: Pepper&amp;Carrot by David Revoy, CC BY 4.0.</p>
  <div class="stats">
