...
export const MODELS = [
  {
    ...
    ocr: [0.0002299, 2.4e-05, 0],
    translate: [0.0009787, 1.55e-05, 2.1e-06],
    proofread: [0.0001962, 3.38e-05, 0],
  },
  {
    id: "gemini-3.5-flash-lite", name: "Gemini 3.5 Flash-Lite",
    backend: "gemini",
    blurb: "A generation newer for not much more. A good default.",
    ocr: [0.0006897, 0.00015, 0],
    translate: [0.0051318, 8.29e-05, 6.3e-06],
    proofread: [0.0005886, 0.0001924, 0],
  },
  {
    id: "claude-haiku-4-5", name: "Claude Haiku 4.5",
    backend: "anthropic",
    blurb: "Claude's small one. Better at holding a voice than its price suggests.",
    ocr: [0.002299, 0.0003, 0],
    translate: [0.0010888, 0.000183, 2.1e-05],
  ...
  },
  {
    ...
    translate: [0.017214, 0.0002745, 3.15e-05],
    proofread: [0.002943, 0.000612, 0],
  },
  {
    id: "claude-sonnet-5", name: "Claude Sonnet 5",
    backend: "anthropic",
    blurb: "The one most people proofread with. Catches what the others miss.",
    ocr: [0.006897, 0.0009, 0],
    translate: [0.0032664, 0.000549, 6.3e-05],
    proofread: [0.0022275, 0.001224, 0],
  },
  {
    id: "claude-opus-5", name: "Claude Opus 5",
    backend: "anthropic",
    blurb: "The best there is, and priced like it. Worth it on a page that matters.",
    ocr: [0.011495, 0.0015, 0],
    translate: [0.005444, 0.000915, 0.000105],
    proofread: [0.0037125, 0.00204, 0],
  },
];
